...
async function init() {
  mapa = await fetch(`/projetoPesca/Mapa/map.geojson`);
  ...
  function zoomToFeature(e) {
    ...
    setTimeout(() => {window.location.href = "/projetoPesca/municipios/" + e.target.feature.properties.html + "/" + e.target.feature.properties.html + ".html";}, 500);
  }
